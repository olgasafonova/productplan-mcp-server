...
Requires: action + roadmap_id`,
			InputSchema: mcp.InputSchema{
				...
				Properties: map[string]mcp.Property{
					...
					"color":      {Type: "string", Description: "Lane color as 6-digit hex code (e.g., #FF5733, #3498DB)"},
				},
...
Requires: action + roadmap_id`,
			InputSchema: mcp.InputSchema{
				...
				Properties: map[string]mcp.Property{
					...
					"date":         {Type: "string", Description: "Date in YYYY-MM-DD format (e.g., 2025-03-15)"},
				},
				Required: []string{"action", "roadmap_id"},
			},
		},
...
Requires: action + bar_id`,
			InputSchema: mcp.InputSchema{
				...
				Properties: map[string]mcp.Property{
					...
					"url":     {Type: "string", Description: "The URL to link to (e.g., https://jira.example.com/PROJ-123)"},
...
Requires: action + idea_id`,
			InputSchema: mcp.InputSchema{
				...
				Properties: map[string]mcp.Property{
					...
					"email":       {Type: "string", Description: "Customer email (optional, for add; e.g., customer@example.com)"},
				},
